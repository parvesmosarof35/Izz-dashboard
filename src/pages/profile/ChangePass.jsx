  ...
  return (
    <div className="bg-white w-full max-w-xl mx-auto px-4 sm:px-6 md:px-8 pt-8 py-5 rounded-md border border-gray-200 shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {/* button */}
        <div className="text-center pt-2 cursor-pointer">
          <button
            type="submit"
            disabled={isLoading}
            className="bg-[#111827] text-white font-semibold w-full py-3 rounded-md hover:opacity-95 transition disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
          >
